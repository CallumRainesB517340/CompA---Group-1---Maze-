...
const int trigPinLS = 12;
const int echoPinLS = 13;
const int trigPinFS = 10;
const int echoPinFS = 11;
const int trigPinRS = 8;
const int echoPinRS = 9;
...
if (distanceLS > 2 && distanceLS < 0  && distanceFS < 2 && distanceFS > 0  && distanceRS < 2 && distanceRS > 0 )
    {
     ...
     else if (distanceLS < 2 && distanceLS > 0  && distanceFS < 2 && distanceFS > 0  && distanceRS > 2 && distanceRS < 0 )
       {
       TurnRight();
       }
         else
